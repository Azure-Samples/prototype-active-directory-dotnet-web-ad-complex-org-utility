    ...
    public static class IdentityExtensions
    {
        ...
        public static string GetClaim(this IIdentity identity, string claimName)
        {
            if (identity == null)
                throw new ArgumentNullException("identity");
            var identity1 = identity as ClaimsIdentity;
            return identity1 != null ? identity1.FindFirst(claimName).Value : null;
        }
        ...
        public static bool SetClaim(this IIdentity identity, string claimName, string newValue)
        {
            ...
            {
                Logging.WriteToAppLog("error setting replacement claim", System.Diagnostics.EventLogEntryType.Error, ex);
                return false;
            }
        }
        ...
        public static bool RemoveClaims(this IIdentity identity, string claimName)
        {
            ...
            {
                Logging.WriteToAppLog("error removing claim", System.Diagnostics.EventLogEntryType.Error, ex);
                return false;
            }
        }
